CREATE TABLE /*_*/subscription (
  ...
  `provider_id` varbinary(255) DEFAULT NULL,
...
ALTER TABLE /*_*/subscription ADD PRIMARY KEY (`sid`), ADD KEY `active` (`active`), ADD KEY `expires_begins` (`expires`,`begins`), ADD KEY `global_id_provider_id` (`global_id`,`provider_id`);
