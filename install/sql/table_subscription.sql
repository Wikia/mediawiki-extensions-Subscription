...
ALTER TABLE `subscription` ADD PRIMARY KEY (`sid`), ADD KEY `active` (`active`), ADD KEY `expires_begins` (`expires`,`begins`), ADD KEY `global_id` (`global_id`);

ALTER TABLE `subscription` MODIFY `sid` int(32) NOT NULL AUTO_INCREMENT;